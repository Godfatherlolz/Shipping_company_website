...
if(!isset($_SESSION))
    ...
    if(!isset($_SESSION["id"]))
        {
          header('Location: ins.php?type=error&message=Connexion requise.');
...
<div class="panel-heading"><div class="text-center"><h2 style="color:white;"><strong>Cotation- Transport Maritime ( Groupage )</strong></h2></div></div>
<div class="panel-body" ><form action="cot_mar_gr.php" method="POST">
...
<h3>Cotation- Transport Maritime ( Groupage )</h3>
  <!---remoreque--->
</div></div><hr>
  <div class='row'>
