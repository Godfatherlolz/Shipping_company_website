...
<div class="form-group" style="position: static;">
  ...
  $('#select2').html(options);
      ...
      <div class="col-md-3 display-no" >
        <label for="select-1"><strong>Type d'unité</strong></label>
          <select class="form-control" id="select2"  style="width: 270px; ">
            <option value="2">Tollée</option>
            <option value="2">Bachée</option>
            <option value="2">Reefer</option>
            <option value="1">20'</option>
            <option value="1">40'</option>
            <option value="1">20'dry</option>
            <option value="1">40'dry</option>
            <option value="1">20'Open Top</option>
            <option value="1">40'Open Top</option>
            <option value="1">20'Flat</option>
            <option value="1">40'Flat</option>
            <option value="1">Hight Cube</option>
            <option value="1">20'Reefer</option>
            <option value="1">40'Reefer</option>
            <option value="1">20'FlexiTank</option>
          </select>
      </div>
      <div class="col-md-3 display-no" >
        <div class="form-group" style="position: static;">
    ...
    <!--script for reefer-->
  <script>  function showOther(){
	document.getElementById('reefer').value = "";
...
function showHideOther(){
    if (document.getElementById('select2').value == 'reefer') {
         showOther();
    } else {
         hideOther();
    }
}</script>
    <!--//end script for reefer-->
      <div class="col-md-3 display-no" id="temp">
        <div class="form-group" style="position: static;">
                    <label><strong>Température </strong></label>
                    <div class="input-group spinner" data-trigger="spinner">
                        <input class="form-control" type="number" min="0.1" step="0.1" style="width: 270px; "/><p>**C</p>
