...
/*$trans2=new trans_m ($idc,$nbr,$poids,$type,$temperature);
$cc->insertTrans_m($cc->conn,$trans2);

$trans3=new trans_m ($idc,$nbr,$poids,$type,$temperature);
$cc->insertTrans_m($cc->conn,$trans3);*/
...
<div class="panel-heading"><div class="text-center"><h2 style="color:white;"><strong>Cotation- Transort Maritime ( Unité Complète )</strong></h2></div></div>
<div class="panel-body" ><form action="test.php" method="POST">
...
<h3>Cotation- Transort Maritime ( Unité Complète )</h3>
  <!---remoreque--->
</div></div><hr>
  <div class='row'>
 ...
 <div class='row'>
   ...
   <!---remoreque--->
    ...
    <div class="row">
      ...
      <input class="form-control" id="nombre1" name="nombrec1" type="number"  min="0.1" step="0.1  "/>
    </div>
   </div>
      <div class='col-md-3'>
        <div class="form-group" style="position: static;">
       ...
       <input class="form-control"  id="gerbable1" name="gerbablec1" type="checkbox" />
     </div>
    </div>   </div>
      </div>
      ...
      <div class="row">
        <div class="colis1">
          <div class='col-md-3'>
            <div class="form-group" style="position: static;">
        <input class="form-control" id="nombre1" name="nombrec2" type="number"  min="0.1" step="0.1  "/>
      </div>
     </div>
        <div class='col-md-3'>
          <div class="form-group" style="position: static;">
        ...
        <div class="row">
          <div class="colis1">
            <div class='col-md-3'>
              <div class="form-group" style="position: static;">
          <input class="form-control" id="nombre1" name="nombrec3" type="number"  min="0.1" step="0.1  "/>
        </div>
       </div>
          <div class='col-md-3'>
            <div class="form-group" style="position: static;">
