            ...
            <div class="row ">
                ...
                <div class="col-md-8">
                    ...
                    <div class="tab-content">
                      ...
                      <a href="displaycotm.php?id=<?php echo $_SESSION['id'];?>">  <button type="button" class="btn btn-success btn-block"><i class="livicon" data-name="anchor" data-size="16" data-c="#ffffff" data-hc="#ffffff" data-loop="true"></i> Cotation Maritime</button></a>
                        </div>
                        <div class="col-md-6 pd-top">
                          <button type="button" class="btn btn-warning btn-block"><i class="livicon" data-name="question" data-size="16" data-c="#ffffff" data-hc="#ffffff" data-loop="true"></i> Cotation (BETA)</button>
                        </div>
                        </div>
                        <div class="row" style="margin-top:50px;">
                          <div class="col-md-6 pd-top">
