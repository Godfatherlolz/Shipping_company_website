            ...
            <div class="row ">
                ...
                <div class="col-md-8">
                    <ul class="nav nav-tabs ul-edit responsive">
                        ...
                        <li class="active">
                            <a href="#tab-cotationmaritimes" data-toggle="tab">
                                <i class="livicon" data-name="anchor" data-size="16" data-c="#01BC8C" data-hc="#01BC8C" data-loop="true"></i> Cotation Maritime <span class="badge"><?php echo $nombretx;?></span>
                            </a>
                        </li>
                        <li>
                            <a href="#tab-cotationtransit" data-toggle="tab">
                                <i class="livicon" data-name="truck" data-size="16" data-c="#01BC8C" data-hc="#01BC8C" data-loop="true"></i> Cotation Transit
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div id="tab-activity" class="tab-pane fade in ">
                          <table class="table table-striped table-advance table-hover web-mail" id="inbox-check1" >
                            <thead>
                              ...
                              <tbody>
                                ...
                                <?php foreach ($list as $l){?>
                                  ...
                                  <tr data-cotationmaritimeid="1" class="unread">
                                      ...
                                      <td  class="view-cotationmaritime hidden-xs">
                                          <a href="user_ticket.php?id=<?php echo $l[0];?>">
                                                 <?php  echo $l[1] ; ?></a>
                                      </td>
                                      <td  class="view-cotationmaritime ">
                                          <a href="user_ticket.php?id=<?php echo $l[0];?>">

                                          </a>
                                      </td>
                                      <td class="view-cotationmaritime inbox-small-cells">

                                            <a href="user_ticket.php?id=<?php echo $l[0];?>"><?php   echo shortText($l[3] , 30);?></a>
                                      </td>
                                      <td  class="view-cotationmaritime text-right">
                        ...
                        <div id="tab-cotationtransit" class="tab-pane fade">
                            <div class="row">
                        ...
                        <div id="tab-cotationmaritimes" class="tab-pane fade in active" style="margin-top:12px;">
